...
2. Random Forest showed signs of overfitting with the train accuaracy being (99.4%), indicating the model memorized the data too well making it unable to generalize well to unseen data.
...
2. Simpler linear models generalized better than complex ensemble methods.

**Future improvements could involve:**

1. Fine-tuning hyperparameters using stratified cross-validation.

2. Exploring deep learning models (LSTM, BERT.) could be an option with a larger dataset. An example is a dataset with many tweets.
